        ...
        <div className="hero-container">
            ...
            <div className="intro">
                <div className="intro-text">
                    ...
                    <p>I utilize these <span>technologies</span> to work on projects and continuously strive to <span>learn</span> and <span>gain</span> experience from them.</p>
                    <p>I have a <span>strong</span> desire to explore different technologies and maintain an open-minded approach to learning <span>new skills</span>.</p>
                </div>
